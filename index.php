...
<head>
    ...
    <title>Welcome to Anizzar Catering</title>
    ...
    <section class="how-it-works" style="background-image:url('images/assets/bghome.jpg'); background-size:cover; background-repeat:no-repeat; height:auto;">
        <div class="container">
            <div class="text-xs-center">
                <h2 style="color:white; font-weight:bold; text-shadow:3px 3px 1px rgba(0,0,0,0.5); padding-top:25px;">Kamu harus tau tentang Catering Anizzar!</h2>
            </div>
