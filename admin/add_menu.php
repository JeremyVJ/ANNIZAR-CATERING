...
if (isset($_POST['submit'])) {
    if (empty($_POST['title']) || $_POST['price'] == '' || empty($_POST['res_name'])) {
...
if ($restaurantResult) {
    ...
    // Handle the error
    echo "Error fetching restaurants: " . mysqli_error($db);
}
?>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Tambahkan Menu Paket Makanan</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" placeholder="Morzirella">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="res_name" class="form-control">
                                                    ...
                                                    foreach ($restaurants as $restaurant) {
                                                        echo "<option value='{$restaurant['rs_id']}'>{$restaurant['title']}</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
