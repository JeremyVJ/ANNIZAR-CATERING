...
if (isset($_POST['submit'])) {
    if (
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Nama pengguna telah digunakan!</strong>
															</div>';
            ...
            $success =     '<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Selamat!</strong> Akun Berhasil ditambahkan.</br></div>';
        }
    }
}
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input type="text" name="fname" class="form-control form-control-danger" placeholder="jim">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="lname" class="form-control" placeholder="jaya">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phone" class="form-control form-control-danger" placeholder="08x xxx xxx xxx">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="address" type="text" style="height:100px;" class="form-control" placeholder="JL. Mastrip, No. 25"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="add_users.php" class="btn btn-inverse">Batal</a>
                                </div>
                                </form>
                            </div>
                        </div>
