...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $mql = "INSERT INTO package_category (c_name) VALUES ('$c_name')";
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Tambah Kategori Makanan</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="c_name" class="form-control" placeholder="Paket Hemat">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT * FROM package_category order by c_id desc";
